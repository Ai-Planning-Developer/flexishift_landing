...
/** ITU-T E.164 calling codes for UN members and common territories. */
...
export function countryByIso(iso: string): CountryCode | undefined {
  return COUNTRY_CODES.find((c) => c.iso === iso);
}

export function defaultCountryIso(lang: 'en' | 'no' | 'sv'): string {
