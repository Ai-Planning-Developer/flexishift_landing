          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'clamp(28px,4vw,48px)', alignItems: 'flex-start', justifyContent: 'space-between' }}>
            <div style={{ flex: '1 1 420px', minWidth: 280, maxWidth: 720 }}>
              ...
              <div style={{ display: 'flex', gap: 14, flexWrap: 'wrap', alignItems: 'center' }}>
                ...
                <Link to="/drivers" style={{ background: 'var(--teal)', color: 'white', padding: 'clamp(12px,2vw,15px) clamp(20px,3vw,30px)', borderRadius: 10, fontWeight: 700, fontSize: 'clamp(14px,1.5vw,16px)', textDecoration: 'none', boxShadow: '0 4px 20px rgba(0,168,150,0.35)' }}>{t.heroCtaDriver}</Link>
